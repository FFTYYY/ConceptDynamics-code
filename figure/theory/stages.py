...
if __name__ == "__main__":
    ...
    if True:
        ...
        xx = outputs[:,0]
        yy = outputs[:,1]
        plt.plot( xx, yy, lw=3, color = cmap(norm(1)), alpha=0.7)
        ...
        for pos in range(50, len(xx) - 1, 100):
            ...
            plt.annotate(
                ...
                arrowprops=dict(arrowstyle='-|>', color=cmap(norm(1)), lw=0, alpha=0.7, mutation_scale=20)
            )
        ...
        fig.annotate(
            ...
            arrowprops = dict(arrowstyle="-[, widthB=6.5, lengthB=.5", lw=1) , 
            rotation = 65 , 
        )

        fig.annotate(
            "Transient Memorization", 
            xy       = (80, 185), 
            xytext   = (53, 178),
            fontsize = 10, 
            ha = "center", 
            va = "center", 
            xycoords = "axes points", 
            arrowprops = dict(arrowstyle="-[, widthB=3.0, lengthB=.5", lw=1) , 
            rotation = 105 , 
        )
        ...
        fig.annotate(
            ...
            va = "center", 
            xycoords = "axes points", 
            arrowprops = dict(arrowstyle="-[, widthB=5.0, lengthB=.5", lw=1) , 
            rotation = -5 , 
        )
    ...
    if True:
        ...
        plt.tight_layout()
        plt.savefig("theory_entries_and_loss.pdf")
        plt.close()
